          ...
          <div className={tilesClasses}>
              ...
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">
                    {t("featuresTiles.tiles1.title")}
                    </h4>
                  <p className="m-0 text-sm">
                    {t("featuresTiles.tiles1.paragraph")}
                    </p>
                </div>
              </div>
            </div>
            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="200">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">
                    {t("featuresTiles.tiles2.title")}
                    </h4>
                  <p className="m-0 text-sm">
                    {t("featuresTiles.tiles2.paragraph")}
                    </p>
                </div>
              </div>
            </div>
            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="400">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">
                    {t("featuresTiles.tiles3.title")}
                    </h4>
                  <p className="m-0 text-sm">
                    {t("featuresTiles.tiles3.paragraph")}
                    </p>
                </div>
              </div>
            </div>
            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="200">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">
                    {t("featuresTiles.tiles5.title")}
                    </h4>
                  <p className="m-0 text-sm">
                    {t("featuresTiles.tiles5.paragraph")}
                    </p>
                </div>
              </div>
            </div>
            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="400">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">
                    {t("featuresTiles.tiles6.title")}
                    </h4>
                  <p className="m-0 text-sm">
                    {t("featuresTiles.tiles6.paragraph")}
                    </p>
                </div>
              </div>
            </div>
